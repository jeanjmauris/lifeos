...
6. If any habit completed less than 50% for two weeks running, flag it
7. If the *Sensitive Context* section in CLAUDE.md is filled, ask once:
   "How are you carrying everything this week?" — then wait. No frameworks.
8. Write `reviews/weekly/YYYY-WNN.md`
9. Append pattern observations to `meta/reflections.md` (dated, specific)
10. Propose one adjustment — habit, schedule, or priority — if the data warrants it
